...
export const OFFSET_ENCRYPTED_SECOND_CHALLENGE: number = OFFSET_MASTER_SIGNATURE + SIZE_MASTER_SIGNATURE;
export const SIZE_ENCRYPTED_SECOND_CHALLENGE: number = 16;
export const OFFSET_SECURITY_SIGNATURE: number = OFFSET_ENCRYPTED_SECOND_CHALLENGE + SIZE_ENCRYPTED_SECOND_CHALLENGE;

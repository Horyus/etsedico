...
export const OFFSET_ERROR_CODE: number = OFFSET_MASTER_SIGNATURE + SIZE_MASTER_SIGNATURE;
export const SIZE_ERROR_CODE: number = 2;
export const OFFSET_SECURITY_SIGNATURE: number = OFFSET_ERROR_CODE + SIZE_ERROR_CODE;

...
const OFFSET_SECOND_HALF_KEY: number = OFFSET_MASTER_SIGNATURE + SIZE_MASTER_SIGNATURE;
const SIZE_SECOND_HALF_KEY: number = 16;
const OFFSET_SECOND_CHALLENGE: number = OFFSET_SECOND_HALF_KEY + SIZE_SECOND_HALF_KEY;
const SIZE_SECOND_CHALLENGE: number = 16;
const OFFSET_ENCRYPTED_FIRST_CHALLENGE: number = OFFSET_SECOND_CHALLENGE + SIZE_SECOND_CHALLENGE;
const SIZE_ENCRYPTED_FIRST_CHALLENGE: number = 16;

const OFFSET_SECURITY_SIGNATURE: number = OFFSET_ENCRYPTED_FIRST_CHALLENGE + SIZE_ENCRYPTED_FIRST_CHALLENGE;
